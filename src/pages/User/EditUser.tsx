...
export function EditUser({ handleClose, onSave, userData }: CreateUserProps) {

    const [state, setState] = useState<UserState>(userData)
    ...
    >
        <DialogTitle id="max-width-dialog-title">Edit User {userData.firstName}</DialogTitle>
        <DialogContent>
            <div>
